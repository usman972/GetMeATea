  ...
  return (
    <div className="text-white py-14 container mx-auto">
      <h1 className=" text-center text-white font-bold text-3xl">
        Login  to Get your friends to support you
      </h1>
      
        <div className="flex flex-col gap-2 min-h-screen items-center  p-10">
          <button className="flex w-64 items-center bg-slate-50 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
          ...
          <button className="flex w-64 items-center border bg-slate-50 border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <button className="flex items-center w-64 border bg-slate-50 border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          <button className="flex items-center border w-64 bg-slate-50 border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-black hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              className="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
